...
if (document.getElementById("contactstab") !== null){ document.getElementById("contactstab").innerHTML = 'Misura';}
...
if (document.getElementById("istruzioni") !== null){ document.getElementById("istruzioni").innerHTML = '15 - 85 percentile : <br>Stato di normalità<br><span style="color: blue; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif !important; ">3 - 15 / 85 - 97 percentile : <br>Patologia lieve e da monitorare</span><br><span style="color: red; font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif !important; ">&lt; 3 / &gt; 97 percentile : <br>Patologia conclamata (si consiglia visita).<br>In relazione alla statura si consiglia visita specialistica (valutazione dell’età ossea, della velocità di crescita, esami ematochimici, ecc)</span>';}
